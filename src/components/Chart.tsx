        ...
        return (
            ...
            >
                ...
                <Chart id={3} height={chartHeight} yExtents={this.candleChartExtents}>
                    <XAxis showGridLines showTickLabel={false} gridLinesStrokeStyle="#333" />
                    <YAxis showGridLines tickFormat={this.pricesDisplayFormat} gridLinesStrokeStyle="#333" tickLabelFill="#fff" />
                    <CandlestickSeries />
                    ...
                    <ZoomButtons />
                    <OHLCTooltip origin={[8, 16]} labelFill="#888" textFill="#fff" />
                </Chart>
                <Chart
                    id={4}
                ...
                >
                    <XAxis showGridLines gridLinesStrokeStyle="#333" tickLabelFill="#fff" />
                    <YAxis ticks={4} tickFormat={this.pricesDisplayFormat} gridLinesStrokeStyle="#333" tickLabelFill="#fff" />
